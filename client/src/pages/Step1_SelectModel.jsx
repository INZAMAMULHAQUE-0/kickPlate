  ...
  <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-white flex flex-col items-center px-4 sm:px-6 py-10">
      ...
      <div className="w-full max-w-2xl text-center mb-10">
        <div className="bg-indigo-100/60 inline-block px-6 py-2 rounded-full mb-4 shadow border border-indigo-200">
          <span className="text-xs sm:text-sm text-black tracking-wide font-extrabold">Step 1 of 8</span>
        </div>
      ...
      {/* Preview Section */}
  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 w-full max-w-3xl mb-8 sm:mb-12 bg-white/80 border-2 border-indigo-100 rounded-2xl shadow-lg py-4 sm:py-8 px-2 sm:px-4">

        {/* Mobile Layout - Preview Box and Strip Side by Side */}
        <div className="flex sm:hidden items-center gap-4">
          {/* Preview Box with Orange Strip */}
          <div className="relative flex flex-col items-center">
            <div className="w-[140px] h-[100px] bg-white border-2 border-indigo-200 rounded-md flex items-center justify-center shadow-xl overflow-hidden relative">
              {/* Left Orange Strip for mobile */}
              <div className="absolute top-0 left-1 h-full w-3 bg-indigo-600 z-10" />
          ...
          <div className="flex flex-col items-center min-w-[50px]">
            <div className="w-3 h-[60px] bg-indigo-600 rounded-md shadow-md" />
            <div className="mt-1 flex flex-col items-center animate-pulse">
              <div className="relative w-10 h-1.5">
                <div className="absolute top-1/2 left-0 w-1.5 h-1.5 border-r-2 border-b-2 border-indigo-600 rotate-[-225deg] -translate-y-1/2" />
                <div className="absolute top-1/2 left-0 w-full h-0.5 bg-indigo-600 rounded" />
                <div className="absolute top-1/2 right-0 w-1.5 h-1.5 border-r-2 border-b-2 border-indigo-600 rotate-[-45deg] -translate-y-1/2" />
              </div>
            </div>
        ...
        <div className="hidden sm:flex sm:flex-col lg:flex-row items-center justify-center gap-8 w-full">
          {/* Preview Box with Right Orange Strip */}
            <div className="relative flex flex-col items-center">
            <div className="w-[240px] h-[160px] lg:w-[360px] lg:h-[240px] bg-white border-2 border-indigo-200 rounded-md flex items-center justify-center shadow-xl overflow-hidden relative">
              {/* Right Orange Strip */}
              <div className="absolute top-0 left-1.5 h-full w-4 lg:w-6 bg-indigo-600 z-10" />
          ...
          <div className="flex flex-col items-center min-w-[90px] pt-6">
            <div className="w-6 h-[120px] lg:h-[180px] bg-indigo-600 rounded-md shadow-md" />
            <div className="mt-3 flex flex-col items-center animate-pulse">
              <div className="relative w-16 lg:w-20 h-2">
                <div className="absolute top-1/2 left-0 w-3 h-3 border-r-2 border-b-2 border-indigo-600 rotate-[-225deg] -translate-y-1/2" />
                <div className="absolute top-1/2 left-0 w-full h-0.25 bg-indigo-600 rounded" />
                <div className="absolute top-1/2 right-0 w-3 h-3 border-r-2 border-b-2 border-indigo-600 rotate-[-45deg] -translate-y-1/2" />
              </div>
            </div>
        ...
        <div className="mb-7">
          ...
          <div className="flex gap-4 items-center">
            <select
              ...
              className="flex-1 p-3 rounded-lg bg-background border border-indigo-200 text-gray-800 font-semibold focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 transition-all"
            >
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-4 items-center">
            ...
            <select
              ...
              className="w-28 p-3 rounded-lg bg-background border border-indigo-200 text-gray-800 font-semibold focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 transition-all"
            >
