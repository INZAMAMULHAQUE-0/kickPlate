...
<div className="absolute bottom-[-60px] left-1/2 -translate-x-1/2 flex flex-col items-center">
  <div className="flex items-center w-[500px] transition-all duration-300 ease-in-out">
  ...
  <div className="mt-1 text-[#5c4033] font-semibold text-sm">
    {formattedShedLength}
  </div>
</div>
      ...
      <div className="w-full max-w-xl flex flex-col gap-6 mb-8">
        {[['Cut Length (200 mm)', 'cutLengthPieces'], ['Trim (3 m)', 'trimLengthPieces'], ['Support (3 m)', 'supportLengthPieces']].map(
          ([label, name]) => (
